...
This page is a short tour of how satellite imagery becomes the kind of dataset social science researchers or policymaker can actually use — what gets collected, what shape it arrives in, and how [Imago]{style="color:#5ecba7"} turns it into neighbourhood-level statistics ready for analysis.
