...
```{r}
msoa_uk <- read_sf("./data/UK_MSOA_IZB_SDZ/UK_MSOA_IZB_SDZ/UK_MSOA_IZB_SDZ.gpkg")
```

### Python

```{python}
msoa_uk = gpd.read_file("./data/UK_MSOA_IZB_SDZ/UK_MSOA_IZB_SDZ/UK_MSOA_IZB_SDZ.gpkg")
```
:::
...
## Animated hotspot exploration

This section explores the intersection of heat and health deprivation using a bivariate animation that zooms into specific hotspots.
