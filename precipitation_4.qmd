...
The resulting table gives one row per MSOA with the total usual resident population count, which can be merged with other MSOA-level datasets in this notebook via the `GEOGRAPHY_CODE` column.
```
:::
