...
2. Switch to the **R runtime** (Runtime → Change runtime type → R). The drive mount persists.
3. Now you can access your files using the mounted path:
...
- [Python notebook](https://colab.research.google.com/drive/1iXXQeRedroYMCKqueB-ZHtdEf3t9pIle?usp=sharing)
- [R notebook](https://colab.research.google.com/drive/1YX0L1V0-9FE68RyVocLaPwpyKr-xPn7t?usp=sharing)

**Step 1: Add the shared folder to your Drive**

1.  Open the shared folder link: [Workshop Data Folder](https://drive.google.com/drive/folders/1SLlkM-yp210y0TYD3lYPM5Y_XgSFPNhg?usp=sharing) <!-- Replace with actual link -->
