...
![Visualising average PM 2.5](/data/msoa_pm25_exceldemo_fig6.png)

## Further explorations

Consider exploring more! The MSOA-level file contains a number of additional variables worth investigating:

-   **Compare multiple pollutants**: How does PM2.5 correlate with other pollution indicators? Are certain areas consistently high across multiple metrics?

-   **Cross-reference with deprivation**: Join other IMD variables and examine whether pollution burden falls disproportionately on more deprived communities.
