...
![Here is what the raw Temperature data (MSOA-level) looks like.](./assets/msoa_temp_exceldemo_fig1.png)
...
![Matched data combined with MSOA-level Health IMD indicators](./assets/msoa_temp_exceldemo_fig2.png)
...
![Sorting by rank and percentile](./assets/msoa_temp_exceldemo_fig3.png)
...
![Simple pivot table](./assets/msoa_temp_exceldemo_fig4.png)
...
![Visualising average Wintry temperatures in England](./assets/msoa_temp_exceldemo_fig5.png)
