...
The imago dataproducts can be found [here](https://data.imago.ac.uk). Have a look!

![Here is what the raw Temperature data (MSOA-level) looks like.](./docs/assets/msoa_temp_exceldemo_fig1.png)
...
![Matched data combined with MSOA-level Health IMD indicators](./docs/assets/msoa_temp_exceldemo_fig2.png)

In this example, the contextual data is stored in a separate table (`Table 2`). This dataset is an MSOA-level compilation of the LSOA-level IMD indicator components and ranks, available [here](https://docs.google.com/spreadsheets/d/1At65pys4xia9BBKeDbNLFkiVQ1Ta-xso/edit?usp=drive_link&ouid=112072621229517004821&rtpof=true&sd=true "IMD Domains (MSOA-Level)"). It was derived using the processes described in [Explore datasets with R/Python](demo1.qmd).
...
![Sorting by rank and percentile](./docs/assets/msoa_temp_exceldemo_fig3.png)
...
![Simple pivot table](./docs/assets/msoa_temp_exceldemo_fig4.png)
...
![Visualising average Wintry temperatures in England](./docs/assets/msoa_temp_exceldemo_fig5.png)
