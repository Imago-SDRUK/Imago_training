...
The Imago air temperature data is hosted on our [data catalogue](https://data.imago.ac.uk/). To download it:

1. **Sign up** for a free account on the [data catalogue](https://data.imago.ac.uk/) and log in.
2. **Search** for `air temperature MSOA` (or browse the [temperature datasets](https://data.imago.ac.uk/datasets?vocab_general=temperature)).
3. Open each yearly dataset — for example, [Air Temperature Indicators per MSOA in 2015](https://data.imago.ac.uk/datasets/air-temperature-indicators-per-msoa-in-2015) — and download the `.gpkg` file.
